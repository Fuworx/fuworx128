...
const OurServices = () => {
  ...
  return (
    <>
      <div className="w-full relative overflow-hidden md:max-w-7xl h-svh md:h-[600px] mx-auto px-10 md:py-16 flex flex-col justify-center text-center">
        <div className="text-5xl text-black/70 text-center font-light mb-10 md:mb-12 font-head md:text-5xl">
