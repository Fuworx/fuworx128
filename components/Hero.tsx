...
function Hero() {
  ...
  return (
    <>
      ...
      <div className="relative w-full bg-[url(../public/Hero.png)] bg-cover bg-no-repeat bg-center bg-blend-multiply bg-black/50 md:bg-black/30 h-[900px]">
        {/* HERO CONTENT */}
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg
            className="block w-full h-[150px] md:h-[180px] lg:h-[200px]"
          ...
          >
            <path
              fill="#ffffff"
              d="M0,288 C120,256 240,192 360,192 C480,192 600,256 720,256 C840,256 960,192 1080,192 C1200,192 1320,256 1440,288 L1440,320 L0,320 Z"
            />
          </svg>
        </div>
      </div>
