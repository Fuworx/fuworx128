        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 font-body text-lg">
              <li className="flex items-center gap-2  text-gray-600 hover:text-teal-600 cursor-pointer transition">
          ...
          <div>
            ...
            <ul className="space-y-2 mb-6">
              <li className="flex items-center gap-2 text-lg text-gray-600 hover:text-teal-600 cursor-pointer transition">
                <IoIosArrowForward className="text-xs" />
