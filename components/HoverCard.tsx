    ...
    <div>
      <div className="w-full max-w-[400px] mx-auto md:max-w-full mb-20 px-2 h-[200px] md:w-auto md:h-auto group rounded-3xl">
        ...
        >
          ...
          <div
            className={`absolute h-full w-auto md:w-full gap-2 bg-black/80 px-4 sm:px-6 md:px-8 mx-auto flex flex-col justify-center items-center text-left -bottom-10 opacity-0 md:group-hover:bottom-0 md:group-hover:opacity-100 duration-200 ease-linear ${isActive ? "!bottom-0 !opacity-100" : ""}`}
          >
            ...
            <div className="font-body max-w-[80ch] mx-auto text-center text-[12px] sm:text-base md:text-[15px] text-white/80 font-semibold w-full">
              {props.description}
            </div>
          </div>
        </div>
