...
const WhyFuworx = () => {
  ...
  return (
    <div className="bg-white">
      <div className="w-full md:max-w-[1400px] text-black/70 py-28 min-w-[200px] px-10 mx-auto flex flex-col justify-center text-center">
        <div
          ref={why}
          className="font-mariweather flex flex-col text-5xl md:py-10"
        >
          Why Choose Fuworx
